...
| 33 | computed 12-int polygon from `n1,n2` then `ta.a(poly,127,wfb)` | `wfb.a(118,15)`; `wfb.a=2`; `B=0`, `q=0`; source bytecode 5563–5843. |
...
| 39 | `uca.a(-b/2,9,new int[]{5,7,9,11,1},-n2)` | `new wfb(...,-n2,0)`; `wfb.a=2`; source bytecode 7036–7128. |
| 40 | `uca.a(-n2,9,new int[]{3,3,7,9,9,11},n1)` | `new wfb(...,-n2,0)`; `wfb.a=3`; `B=0`, `q=0`; source bytecode 5558–5651. |
| 41 | `uca.a(-b/2,9,new int[]{5,7,11,7,11,1},-n2)` | `new wfb(...,-n2,0)`; `wfb.a=2`; source bytecode 7135–7128 continuation. |
